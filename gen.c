           ...
           int loopendlabel, int parentASTop)
{
    ...
    case A_LE:
    case A_GE:
        // If the parse AST node is an A_IF, A_WHILE or A_TERNARY, generate a compare
    ...
    case A_ASSIGN:
        ...
        // make it the right child so that we call fall into the assignment code.
        switch (n->op)
        {
        case A_ASPLUS:
...
static int genSWITCH(struct ASTnode *n)
{
    ...
    // Create arrays for the case values and assoociated lables.
